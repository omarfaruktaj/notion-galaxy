...
<Tabs defaultValue="with-json" className="w-full ">
 <div className="flex items-center justify-center">
   <TabsList className="w-96 rounded-full ">
    ...
    <TabsTrigger value="base"  className="rounded-full">Base</TabsTrigger>
  </TabsList>
 </div>
  <TabsContent value="with-json"><CreateDatabaseWithJSONForm pages={pages??[]}/></TabsContent>
  <TabsContent value="base"><CreateDatabaseForm pages={pages ?? []} /></TabsContent>
</Tabs>
